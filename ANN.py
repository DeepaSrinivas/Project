...
filename = r'D:\PROJECT\ITB8_Geo Tracking Of Waste And Triggering Alerts And Mapping Areas With High Waste Index\Location Based Garbage Management System for Smart City FULL DOCUMENT\CODE smartwastage\bin.csv' #load CSV file
